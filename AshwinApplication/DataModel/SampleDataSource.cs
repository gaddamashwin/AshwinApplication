...
namespace AshwinApplication.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : AshwinApplication.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            // Simple linear search is acceptable for small data sets
            //var matches = _sampleDataSource.AllGroups.Where((item) => item.UniqueId.Equals(uniqueId));
            //if (matches.Count() == 1) return matches.First();
            return null;
        }
